...
<div id="layout" class="easyui-layout">
    <div data-options="collapsible:false,region:'west',split:true" style="width: 280px;">
        <ul id="tree"></ul>
    </div>
    <div id="layout_c" class="easyui-layout" data-options="border: true,region:'center'" style="padding: 0; overflow: hidden">
        <div data-options="region:'north',split:true" style="padding: 0; height: 300px; overflow: hidden">
        ...
        <div data-options="region:'center',split:true,title:''">
            <div id="toolbar_items">
                <div id="regCommand_items" style="display: block;">
                    <a id="btnAdd_items" href="javascript:void(0)">新增</a>
                    <a id="btnEdit_items" href="javascript:void(0)">修改</a>
                    <a id="btnDelete_items" href="javascript:void(0)">删除</a>
                </div>
            </div>
